 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ErrorReply implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ErrorReply';
...
'name' => 'getName'    ];
    ...
    const NAME_NOT_AUTHORIZED = 'not_authorized';
const NAME_BAD_PARAMETER = 'bad_parameter';
const NAME_BAD_REQUEST = 'bad_request';
...
self::NAME_BAD_PARAMETER,
self::NAME_BAD_REQUEST,        ];
    }
