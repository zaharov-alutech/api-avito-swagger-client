...
/**
 * VacanctCreateResult Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VacanctCreateResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VacanctCreateResult';
...
'url' => 'getUrl'    ];
     ...
     * Sets id
     *
     * @param string $id Идентификатор добавленной вакансии.
     *
     * @return $this
     */
