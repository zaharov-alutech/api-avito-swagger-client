 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CpaError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CpaError';
...
'message' => 'getMessage'    ];
     ...
     * Sets code
     *
     * @param int $code Внутренний код ошибки  Возможные значения: - 1000 - пустой запрос - 1001 - ошибка валидации - 1002 - ошибка авторизации - 1003 - внутренняя ошибка - 1004 - не найдено
     *
     * @return $this
     */
