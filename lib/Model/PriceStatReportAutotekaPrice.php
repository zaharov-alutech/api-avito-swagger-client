...
/**
 * PriceStatReportAutotekaPrice Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PriceStatReportAutotekaPrice implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PriceStatReportAutoteka_price';
...
'lowest' => 'getLowest'    ];
     ...
     * Sets average
     *
     * @param int $average Средняя цена
     *
     * @return $this
     */
     ...
     * Sets highest
     *
     * @param int $highest Максимальная цена
     *
     * @return $this
     */
     ...
     * Sets lowest
     *
     * @param int $lowest Минимальная цена
     *
     * @return $this
     */
