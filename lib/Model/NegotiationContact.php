...
/**
 * NegotiationContact Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NegotiationContact implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Negotiation_contact';
...
'chat_link' => 'getChatLink'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['chat_link'] = isset($data['chat_link']) ? $data['chat_link'] : null;
    }
     ...
     * Sets name
     *
     * @param string $name Имя соискателя
     *
     * @return $this
     */
     ...
     * Sets phone
     *
     * @param string $phone Номер телефона соискателя. Выводится при наличии разрешения от соискателя
     *
     * @return $this
     */
    ...
    {
        return $this->container['chat_link'];
    }

    /**
     * Sets chat_link
     *
     * @param string $chat_link Ссылка на чат с соискателем
     *
     * @return $this
     */
    public function setChatLink($chat_link)
    {
        $this->container['chat_link'] = $chat_link;
