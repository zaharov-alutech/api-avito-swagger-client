...
/**
 * NegotiationResume Class Doc Comment
 *
 * @category Class
 * @description Резюме соискателя. Выводится в откликах типа &#x60;invitation&#x60; и при наличии у соискателя резюме в откликах типа &#x60;response&#x60;
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NegotiationResume implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Negotiation_resume';
...
'params' => 'getParams'    ];
     ...
     * Sets photos
     *
     * @param \Swagger\Client\Model\Photo[] $photos Присутствует в ответе только если в запросе есть флаг resume_photos=true
     *
     * @return $this
     */
