...
self::PACKAGE_ID_QUICK_SALE,        ];
     ...
     * Sets package_id
     *
     * @param string $package_id Идентификатор пакета услуг, возможные варианты значения: - `turbo_sale` - применение пакета [Турбопродажа](https://support.avito.ru/articles/200026838) - `quick_sale` - применение пакета [Быстрая продажа](https://support.avito.ru/articles/679)
     *
     * @return $this
     */
