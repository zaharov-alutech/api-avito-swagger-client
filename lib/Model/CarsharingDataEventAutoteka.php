...
/**
 * CarsharingDataEventAutoteka Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CarsharingDataEventAutoteka implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CarsharingDataEventAutoteka';
...
'inaccurate_data' => 'inaccurateData'    ];
    ...
    protected static $setters = [
        'company' => 'setCompany',
'inaccurate_data' => 'setInaccurateData'    ];
    ...
    protected static $getters = [
        'company' => 'getCompany',
'inaccurate_data' => 'getInaccurateData'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['inaccurate_data'] = isset($data['inaccurate_data']) ? $data['inaccurate_data'] : null;
    }
     ...
     * Sets company
     *
     * @param string $company Компания эксплуатант ТС
     *
     * @return $this
     */
    ...
    /**
     * Gets inaccurate_data
     *
     * @return Bool
     */
    public function getInaccurateData()
    {
        return $this->container['inaccurate_data'];
    }

    /**
     * Sets inaccurate_data
     *
     * @param Bool $inaccurate_data Автомобиль мог не использоваться в каршеринге. Такое возможно, если компания оказывает услуги лизинга помимо каршеринга.
     *
     * @return $this
     */
    public function setInaccurateData($inaccurate_data)
    {
        $this->container['inaccurate_data'] = $inaccurate_data;
