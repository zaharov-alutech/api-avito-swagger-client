...
/**
 * ShipmentCreateAcceptanceCertReply Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShipmentCreateAcceptanceCertReply implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShipmentCreateAcceptanceCertReply';
    ...
    protected static $setters = [
        'acceptance_cert' => 'setAcceptanceCert'    ];
    ...
    protected static $getters = [
        'acceptance_cert' => 'getAcceptanceCert'    ];
    ...
    {
        $this->container['acceptance_cert'] = isset($data['acceptance_cert']) ? $data['acceptance_cert'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['acceptance_cert'] === null) {
            $invalidProperties[] = "'acceptance_cert' can't be null";
        }
    ...
    /**
     * Gets acceptance_cert
     *
     * @return string
     */
    public function getAcceptanceCert()
    {
        return $this->container['acceptance_cert'];
    }

    /**
     * Sets acceptance_cert
     *
     * @param string $acceptance_cert Строка, содержащая акт приема-передачи в формате PDF
     *
     * @return $this
     */
    public function setAcceptanceCert($acceptance_cert)
    {
        $this->container['acceptance_cert'] = $acceptance_cert;
