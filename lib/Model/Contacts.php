...
'email' => 'getEmail'    ];
     ...
     * Sets name
     *
     * @param string $name Имя менеджера, контактного лица компании по данному объявлению (строка длиной от 0 до 40 символов)
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email Email (строка длиной от 0 до 255 символов)
     *
     * @return $this
     */
