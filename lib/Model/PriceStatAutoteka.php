...
/**
 * PriceStatAutoteka Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PriceStatAutoteka implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PriceStatAutoteka';
...
'report' => '\Swagger\Client\Model\PriceStatReportAutoteka',
'status' => 'string',
'type' => 'string'    ];
...
self::STATUS_OK,        ];
     ...
     * Gets report
     *
     * @return \Swagger\Client\Model\PriceStatReportAutoteka
     */
     ...
     * Sets report
     *
     * @param \Swagger\Client\Model\PriceStatReportAutoteka $report report
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Полный или нет отчет
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Источник данных
     *
     * @return $this
     */
