...
/**
 * NegotiationUser Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NegotiationUser implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Negotiation_user';
...
'profile_link' => 'getProfileLink'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['profile_link'] = isset($data['profile_link']) ? $data['profile_link'] : null;
    }
     ...
     * Sets id
     *
     * @param int $id Идентификатор соискателя
     *
     * @return $this
     */
     ...
     * Sets profile_link
     *
     * @param string $profile_link Ссылка на профиль соискателя
     *
     * @return $this
     */
