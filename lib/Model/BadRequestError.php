...
class BadRequestError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BadRequest_error';
...
'reason' => 'getReason'    ];
    ...
    const TYPE_DATA = 'bad_json_data';
const REASON_IS_EMPTY = 'is_empty';
const REASON_WRONG_VALUE = 'wrong_value';
const REASON_CHOSEN_AREA_IS_NOT_A_LEAF_OR_NOT_EXIST = 'chosen_area_is_not_a_leaf_or_not_exist';
const REASON_CHOSEN_PHONE_BELONGS_TO_ANOTHER_USER = 'chosen_phone_belongs_to_another_user';
const REASON_NO_PHONE_FOR_AUTO_SUBSTITUTION = 'no_phone_for_auto_substitution';
    ...
    {
        return [
            self::REASON_IS_EMPTY,
self::REASON_WRONG_VALUE,
self::REASON_CHOSEN_AREA_IS_NOT_A_LEAF_OR_NOT_EXIST,
self::REASON_CHOSEN_PHONE_BELONGS_TO_ANOTHER_USER,
self::REASON_NO_PHONE_FOR_AUTO_SUBSTITUTION,        ];
    }
     ...
     * Sets reason
     *
     * @param string $reason Причина возникновения ошибки (может не присутствовать)
     *
     * @return $this
     */
