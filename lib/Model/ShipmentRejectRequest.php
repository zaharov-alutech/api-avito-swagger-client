...
/**
 * ShipmentRejectRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShipmentRejectRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShipmentRejectRequest';
...
const REASON_CODE_NOT_TIME_FOR_SHIPPING = 'NOT_TIME_FOR_SHIPPING';
const REASON_CODE_INCORRECT_SPEC = 'INCORRECT_SPEC';
...
self::REASON_CODE_NOT_TIME_FOR_SHIPPING,
self::REASON_CODE_INCORRECT_SPEC,        ];
    }
     ...
     * Sets reason_code
     *
     * @param string $reason_code Код причины
     *
     * @return $this
     */
