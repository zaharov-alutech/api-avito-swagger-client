...
/**
 * EditingForbiddenErrorError Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EditingForbiddenErrorError implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EditingForbiddenError_error';
...
'value' => 'getValue'    ];
    ...
    const TYPE_VACANCIES = 'vacancies';
const VALUE_CHOSEN_VACANCY_BELONGS_TO_ANOTHER_USER = 'chosen_vacancy_belongs_to_another_user';
const VALUE_UNAVAILABLE_FOR_BLOCKED = 'unavailable_for_blocked';
const VALUE_UNAVAILABLE_FOR_REMOVED = 'unavailable_for_removed';
const VALUE_UNAVAILABLE_TO_CHANGE_LOCATION = 'unavailable_to_change_location';
const VALUE_UNAVAILABLE_TO_EDIT = 'unavailable_to_edit';
    ...
    {
        return [
            self::VALUE_CHOSEN_VACANCY_BELONGS_TO_ANOTHER_USER,
self::VALUE_UNAVAILABLE_FOR_BLOCKED,
self::VALUE_UNAVAILABLE_FOR_REMOVED,
self::VALUE_UNAVAILABLE_TO_CHANGE_LOCATION,
self::VALUE_UNAVAILABLE_TO_EDIT,        ];
    }
