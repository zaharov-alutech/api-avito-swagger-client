...
/**
 * ShipmentListReply Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShipmentListReply implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShipmentListReply';
    ...
    protected static $swaggerTypes = [
        'data' => '\Swagger\Client\Model\ShipmentReply[]',
'has_more' => 'bool'    ];
...
'has_more' => 'getHasMore'    ];
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\ShipmentReply[] $data Список отправлений, найденных по заданным условиям поиска
     *
     * @return $this
     */
     ...
     * Sets has_more
     *
     * @param bool $has_more Доступна ли следующая страница списка отправлений
     *
     * @return $this
     */
