...
/**
 * NegotiationListMeta Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NegotiationListMeta implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NegotiationList_meta';
...
'count' => 'getCount'    ];
     ...
     * Sets cursor
     *
     * @param int $cursor Курсор поиска, возвращается в ответе первого запроса и если не указан, то страница всегда начинается с первой
     *
     * @return $this
     */
     ...
     * Sets per_page
     *
     * @param Interger $per_page Количество откликов на странице
     *
     * @return $this
     */
     ...
     * Sets count
     *
     * @param int $count Количество откликов
     *
     * @return $this
     */
