...
/**
 * ShipmentReply Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShipmentReply implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShipmentReply';
    ...
    protected static $swaggerTypes = [
        'shipment_id' => 'int',
'status' => 'string',
'items' => '\Swagger\Client\Model\ItemReply[]',
'created' => 'int'    ];
...
'created' => 'getCreated'    ];
     ...
     * Sets shipment_id
     *
     * @param int $shipment_id Уникальный идентификатор отправления
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status Текущий статус отправления
     *
     * @return $this
     */
     ...
     * Gets items
     *
     * @return \Swagger\Client\Model\ItemReply[]
     */
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\ItemReply[] $items Список товарных позиций в отправлении
     *
     * @return $this
     */
     ...
     * Sets created
     *
     * @param int $created Метка времени создания
     *
     * @return $this
     */
