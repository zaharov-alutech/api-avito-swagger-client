...
'sell_by_pro_seller' => 'sellByProSeller'    ];
...
'sell_by_pro_seller' => 'setSellByProSeller'    ];
...
'sell_by_pro_seller' => 'getSellByProSeller'    ];
...
self::STATUS_NOT_FOUND,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sell_by_pro_seller'] = isset($data['sell_by_pro_seller']) ? $data['sell_by_pro_seller'] : null;
    }
    ...
    /**
     * Gets sell_by_pro_seller
     *
     * @return Bool
     */
    public function getSellByProSeller()
    {
        return $this->container['sell_by_pro_seller'];
    }

    /**
     * Sets sell_by_pro_seller
     *
     * @param Bool $sell_by_pro_seller Если значение поля true, то у продавца есть автомобили, которые размещали на Авито в течение 3 месяцев. Есть шанс, что и эта машина куплена для перепродажи
     *
     * @return $this
     */
    public function setSellByProSeller($sell_by_pro_seller)
    {
        $this->container['sell_by_pro_seller'] = $sell_by_pro_seller;
